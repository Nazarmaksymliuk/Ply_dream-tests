...
public class SerealizedMaterialInCatalogUsingApiTest extends PlaywrightUiApiBaseTest {
    ...
    @Test
    @Order(0)
    @DisplayName("Create Serialized Item test")
    void createMaterial() {
        ...
        materialSpecsPage.checkSerializedCheckBox();
    ...
    @Test
    @Order(1)
    @DisplayName("Update Serialized Item test")
    void updateMaterial() {
        catalogPage.waitForLoaded();
    ...
    @Test
    @Order(2)
    @DisplayName("Delete Serialized Item test")
    void deleteMaterial() {
        catalogPage.waitForLoaded();
